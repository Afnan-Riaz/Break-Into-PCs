    ...
    return (
        <div className="text-white px-28">
            ...
            <section className="py-10 bg-dark-gradient">
                ...
                <h2 className="max-w-xl mt-6 mb-6 text-xl font-semibold leading-loose tracking-wide md:text-2xl text-gray-300">
                ...
                <li>
                <a>
                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="w-4 mr-1 text-gray-400 bi bi-star " viewBox="0 0 16 16">
                ...
                <p className="mb-4 text-xs underline text-gray-400 hover:text-gray-300 lg:mb-0" href="#">
                Not Rated Yet
                </p>
                </div>
                <p className="inline-block text-2xl font-semibold text-gray-400 ">
                <span>Rs.7,000.00</span>
                <span className="ml-3 text-base font-normal line-through text-gray-400">Rs.10,000.00</span>
                </p>
                </div>
                <div className="mb-6">
                <h2 className="mb-2 text-lg font-bold text-gray-400">System Specs :</h2>
                ...
                <div>
                <p className="mb-2 text-sm font-medium ttext-gray-400">
                Processor
                </p>
                <h2 className="text-base font-semibold text-gray-400">
                INTEL 80486
                ...
                <span className="text-base text-gray-400">In Stock</span>
                ...
                <button className="w-20 h-full text-black bg-gray-100 border-r rounded-l outline-none cursor-pointer border-gray-700 hover:bg-gray-200 hover:text-gray-700 ">
                <span className="m-auto text-2xl font-thin">-</span>
                </button>
                <input type="number" className="flex items-center w-full font-semibold text-center text-black bg-gray-100 outline-none placeholder-gray-400 focus:outline-none text-md hover:text-black" value="1" placeholder="1"/>
                <button className="w-20 h-full text-black bg-gray-100 border-l rounded-r outline-none cursor-pointer border-gray-200 hover:bg-gray-200 hover:text-gray-700 ">
                <span className="m-auto text-2xl font-thin">+</span>
                </button>
                </div>
                </div>
