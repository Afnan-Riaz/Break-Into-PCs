    ...
    return (
        <div className="text-white px-28">
            ...
            <section className="py-10 bg-dark-gradient">
                ...
                <div className="mb-6 ">
                <span className="px-2.5 py-0.5 text-xs text-red-600 bg-red-100 dark:bg-gray-700 rounded-xl dark:text-gray-200">Latest</span>
                ...
                <p className="mb-4 text-xs underline hover:text-red-600 dark:text-gray-400 dark:hover:text-gray-300 lg:mb-0" href="#">
                Not Rated Yet
                </p>
                </div>
                ...
                <button className="w-20 h-full text-black bg-gray-100 border-r rounded-l outline-none cursor-pointer dark:border-gray-700 dark:hover:bg-gray-200 hover:text-gray-700 hover:bg-gray-300">
                <span className="m-auto text-2xl font-thin">-</span>
                </button>
                <input type="number" className="flex items-center w-full font-semibold text-center text-black placeholder-gray-700 bg-gray-100 outline-none dark:placeholder-gray-400 focus:outline-none text-md hover:text-black" value="1" placeholder="1"/>
                <button className="w-20 h-full text-black bg-gray-100 border-l rounded-r outline-none cursor-pointer dark:border-gray-200 dark:hover:bg-gray-200 dark: hover:text-gray-700 hover:bg-gray-300">
                <span className="m-auto text-2xl font-thin">+</span>
                </button>
                </div>
                </div>
