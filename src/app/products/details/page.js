...
export default function Cart() {
    ...
    return (
        <div className="text-white px-28">
            ...
            <section className="py-10 bg-dark-gradient">
                ...
                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="w-5 h-5 text-red-200 bi bi-chevron-left" viewBox="0 0 16 16">
                ...
                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="w-5 h-5 text-red-200 bi bi-chevron-right" viewBox="0 0 16 16">
                ...
                <a className="block border border-gray-700 hover:border-red-300" href="#">
                <img className="object-contain w-full lg:h-28" src="https://i.postimg.cc/Z5KhRkD6/download-1-removebg-preview.png" alt=""/>
                </a>
                </div>
                <div className="w-1/2 p-2 sm:w-1/4">
                <a className="block border border-gray-700 hover:border-red-300" href="#">
                <img className="object-contain w-full lg:h-28" src="https://i.postimg.cc/8kJBrw03/download-removebg-preview.png" alt=""/>
                </a>
                </div>
                <div className="w-1/2 p-2 sm:w-1/4">
                <a className="block border border-gray-700 hover:border-red-300" href="#">
                <img className="object-contain w-full lg:h-28" src="https://i.postimg.cc/0jwyVgqz/Microprocessor1-removebg-preview.png" alt=""/>
                </a>
                </div>
                <div className="w-1/2 p-2 sm:w-1/4">
                <a className="block border border-gray-700 hover:border-red-300" href="#">
                <img className="object-contain w-full lg:h-28" src="https://i.postimg.cc/0N4Kk1PN/black-microprocessors-removebg-preview.png" alt=""/>
                </a>
                </div>
                </div>
                </div>
                ...
                <div className="mb-6 ">
                <span className="px-2.5 py-0.5 text-xs bg-gray-700 rounded-xl text-gray-200">Latest</span>
                <h2 className="max-w-xl mt-6 mb-6 text-xl font-semibold leading-loose tracking-wide md:text-2xl text-white">
                ...
                <li>
                <a>
                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="w-4 mr-1 text-gray-200 bi bi-star " viewBox="0 0 16 16">
                ...
                <p className="mb-4 text-xs underline text-gray-200 hover:text-white lg:mb-0" href="#">
                Not Rated Yet
                </p>
                </div>
                <p className="inline-block text-2xl font-semibold text-gray-200 ">
                <span>Rs.7,000.00</span>
                <span className="ml-3 text-base font-normal line-through text-gray-200">Rs.10,000.00</span>
                </p>
                </div>
                <div className="mb-6">
                <h2 className="mb-2 text-lg font-bold text-gray-200">System Specs :</h2>
                <div className="border border-red border-solid-1px rounded-xl">
                <div className="p-3 lg:p-5 ">
                <div className="p-2 rounded-xl lg:p-6">
                ...
                <div>
                <p className="mb-2 text-sm font-medium ttext-gray-200">
                Processor
                </p>
                <h2 className="text-base font-semibold text-gray-200">
                INTEL 80486
                ...
                <span className="text-base text-gray-200">In Stock</span>
                <p className="mt-2 text-sm text-red-200">
                <span className="text-gray-200">
                Most customers receive within 2-5 days.
                </span>
                </p>
                </div>
                ...
                <button onClick={()=>{setQuantity(quantity-=1)}} className="w-20 h-full text-black bg-gray-100 border-r rounded-l outline-none cursor-pointer border-gray-200 hover:bg-gray-200 hover:text-gray-700 ">
                <span className="m-auto text-2xl font-thin">-</span>
                </button>
                <input type="number" className="flex items-center w-full font-semibold text-center text-black bg-gray-100 outline-none placeholder-gray-400 focus:outline-none text-md hover:text-black" value={quantity} onChange={(e)=>setQuantity(e.target.value)} placeholder="1"/>
                <button onClick={()=>{setQuantity(quantity+=1)}} className="w-20 h-full text-black bg-gray-100 border-l rounded-r outline-none cursor-pointer border-gray-200 hover:bg-gray-200 hover:text-gray-700 ">
                <span className="m-auto text-2xl font-thin">+</span>
                </button>
                </div>
                </div>
                ...
                <button className="flex items-center justify-center w-full h-10 p-2 mr-4 border lg:w-11 border-red-600 hover:border-red-600 bg-red-600 hover:bg-red-500 hover:border-red-500 hover:text-gray-100">
                ...
                <Link
                    href={"/products/cart"}
                    className="bg-size-200 bg-center font-semibold underline underline-offset-8 text-lg hover:bg-pos-0 transition-all duration-500 border-0 py-3 px-6 rounded-md group"
                >
                    View Cart
                    <Image
                    alt="photo"
