...
export default function Cart() {
    ...
    return (
        <div className="text-white relative px-8 md:px-28 overflow-hidden">
                                ...
                                <div className="sticky top-0 overflow-hidden ">
                                    <div className="relative mb-6 lg:mb-10 lg:h-96">
                                        ...
                                        >
                                            <svg
                                                ...
                                                height="16"
                                                fill="currentColor"
                                                className="w-5 h-5 text-red-200 bi bi-chevron-left"
                                                viewBox="0 0 16 16"
                                            >
                                                <path
                                                    fill-rule="evenodd"
                                        ...
                                        >
                                            <svg
                                                ...
                                                height="16"
                                                fill="currentColor"
                                                className="w-5 h-5 text-red-200 bi bi-chevron-right"
                                                viewBox="0 0 16 16"
                                            >
                                                <path
                                                    fill-rule="evenodd"
                                    ...
                                    <div className="flex-wrap hidden -mx-2 md:flex">
                                        <div className="w-1/2 p-2 sm:w-1/4">
                                            <a
                                                className="block border border-gray-700 hover:border-red-300"
                                                href="#"
                                            >
                                                <img
                                ...
                                <div className="lg:pl-20">
                                    <div className="mb-6 ">
                                        ...
                                        <div className="flex flex-wrap items-center mb-6">
                                                ...
                                                <li>
                                                    <a>
                                                        <svg
                                                            ...
                                                            height="16"
                                                            fill="currentColor"
                                                            className="w-4 mr-1 text-gray-200 bi bi-star "
                                                            viewBox="0 0 16 16"
                                                        >
                                            ...
                                            <p
                                                className="mb-4 text-xs underline text-gray-200 hover:text-white lg:mb-0"
                                                href="#"
                                            >
                                                Not Rated Yet
                                            </p>
                                        </div>
                                        <p className="inline-flex flex-wrap text-2xl font-semibold text-gray-200 ">
                                            <span>Rs.7,000.00</span>
                                            <span className="ml-3 text-base font-normal line-through text-gray-200">
                                                Rs.10,000.00
                                            </span>
                                        </p>
                                    </div>
                                            ...
                                            <div className="w-28">
                                                <div className="relative flex flex-row w-full h-10 bg-transparent rounded-lg">
                                                    <button
                                                        ...
                                                        className="w-20 h-full text-black bg-gray-100 border-r rounded-l outline-none cursor-pointer border-gray-200 hover:bg-gray-200 hover:text-gray-700 "
                                                    >
                                                    ...
                                                    <input
                                                        type="number"
                                                        className="flex items-center w-full font-semibold text-center text-black bg-gray-100 outline-none placeholder-gray-400 focus:outline-none text-md hover:text-black"
                                                        value={quantity}
                                                        onChange={(e) =>
                                                            setQuantity(
                                                                e.target.value
                                                    ...
                                                    <button
                                                        ...
                                                        className="w-20 h-full text-black bg-gray-100 border-l rounded-r outline-none cursor-pointer border-gray-200 hover:bg-gray-200 hover:text-gray-700 "
                                                    >
                                                        <span className="m-auto text-2xl font-thin">
                                                            +
                                                        </span>
