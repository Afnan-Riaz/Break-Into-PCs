    ...
    return (
        <div className="text-white px-28">
            ...
            <div className="my-16">
                ...
                <Link
                    href={"/products/games"}
                    className="bg-size-200 bg-center font-semibold -mb-10 text-lg hover:bg-pos-0 transition-all duration-500 bg-red-gradient border-0 py-3 px-6 rounded-md group"
                >
                    Explore All
                    <Image
                    alt="photo"
