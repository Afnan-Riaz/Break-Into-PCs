        ...
        <div>
            <div class="container px-5 py-24 mx-auto text-white">
                ...
                <div class="flex justify-evenly flex-wrap -m-4">
                    <div class="w-80 bg-dark-gradient rounded-lg p-5">
                        <Image
                            width={400}
                            height={400}
                            alt="item"
                            class="object-contain object-center w-full h-48"
                            src="/images/pc-1.png"
                        />
                        <h4 className="font-medium text-center my-3 text-white">Ultron Gamers Edition</h4>
                        <ul className="space-y-2 mb-6">
                            <li className="flex gap-3 items-center">
                                <Image className="h-5 w-5" src={"/icons/cpu.png"} width={200} height={200}/>
                                <p className="font-light text-neutral-300 text-xs">Ryzen 5 5600 CPU</p>
                            </li>
                            <li className="flex gap-3 items-center">
                                <Image className="h-5 w-5" src={"/icons/gpu.png"} width={200} height={200}/>
                                <p className="font-light text-neutral-300 text-xs">GTX 1660 Super Used Graphics Card</p>
                            </li>
                            <li className="flex gap-3 items-center">
                                <Image className="h-5 w-5" src={"/icons/ssd.png"} width={200} height={200}/>
                                <p className="font-light text-neutral-300 text-xs">256GB Nvme + 1TB HDD Used</p>
                            </li>
                            <li className="flex gap-3 items-center">
                                <Image className="h-5 w-5" src={"/icons/power-supply.png"} width={200} height={200}/>
                                <p className="font-light text-neutral-300 text-xs">600W Power Supply</p>
                            </li>
                            <li className="flex gap-3 items-center">
                                <Image className="h-5 w-5" src={"/icons/motherboard.png"} width={200} height={200}/>
                                <p className="font-light text-neutral-300 text-xs">Gigabyte B550m DS3H AC Motherboard</p>
                            </li>
                            <li className="flex gap-3 items-center">
                                <Image className="h-5 w-5" src={"/icons/case.png"} width={200} height={200}/>
